...
export function ImageCropPage(): JSX.Element {
  ...
  const editorLabels = useMemo<ImageCropEditorLabels>(
    () => ({
      ...
      rotateLeft: t("tool.image-crop.rotateLeft"),
      rotateRight: t("tool.image-crop.rotateRight"),
      flipHorizontal: t("tool.image-crop.flipHorizontal"),
      flipVertical: t("tool.image-crop.flipVertical"),
